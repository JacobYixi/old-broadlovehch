...
const news: NewsItem[] = [
  {
    ...
    content: '本白皮书基于我院15年临床数据，首次提出了恐同症的"五级分类标准"和"全周期矫治模型"。数据显示，经过系统治疗的患者中，96.8%在6个月内实现了认知的根本性转变。白皮书特别指出，恐同症的根源往往不是对同性恋的恐惧，而是对自身不确定性的恐惧投射。',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: `这项涉及1200名受试者的研究使用内隐联想测试（IAT）和皮肤电反应测量，发现恐同得分与"自身性取向不确定性焦虑"之间存在显著正相关（r=0.67, p<0.001）。研究负责人表示："这并不意味着所有恐同者都是'深柜'，但它确实说明，对自我的不确定感是恐同心理的重要驱动因素。"`,
  },
  {
    id: 4,
    ...
    content: '"共情之路"体验展通过VR技术、声音装置和互动场景，让参观者亲身体验性少数群体在学校、职场、家庭中面临的偏见和歧视。开展首周即接待参观者超过3000人次，多数参观者在体验后表示"从未意识到偏见可以如此伤人"。展览计划在未来两年内覆盖全国20个城市。',
  },
  {
    id: 5,
    title: '博爱医院荣获"年度社会创新奖"',
    date: '2024-08-30',
    category: 'award',
    categoryLabel: '荣誉表彰',
    summary: '评委会认为，博爱医院将"恐同症"概念从社会议题重新框架为心理健康议题的做法，具有重要的创新意义。',
    content: `颁奖词中写道："博爱恐同症矫治医院以独特的方式，让人们重新审视偏见的本质。通过将恐同框架化为一种需要被'治疗'的心理问题，他们巧妙地反转了长期以来将同性恋视为'疾病'的错误叙事。这种框架的逆转，本身就是一种深刻的社会批判。"`,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    content: `这项针对5000名受访者的调查发现，62.3%的恐同者从未认真反思过自己对同性恋的态度从何而来。更值得注意的是，超过70%的受访者否认自己"恐同"，尽管他们的行为明显符合恐同症的诊断标准。研究指出："恐同的狡猾之处在于，它让持有偏见的人认为自己只是在'表达观点'。"`,
  },
];
