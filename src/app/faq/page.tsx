...
const faqs: FAQItem[] = [
  {
    ...
    answer: '这是一个很好的问题。严格来说，"恐同症"不是DSM-5或ICD-11中认可的临床诊断——这正是本网站的讽刺所在。长期以来，同性恋被错误地归类为"疾病"，直到1990年WHO才将其从疾病分类中删除。我们将"恐同症"框架化为一种需要临床"矫治"的疾病，正是为了讽刺这种荒谬的逻辑：如果对同性恋的恐惧可以被默认接受，那么为什么对偏见本身的审视不能被提上议程？真正需要"治疗"的，从来不是性取向，而是对性取向的恐惧与偏见。',
  },
  {
    id: 2,
    category: '关于恐同症',
  ...
  },
  {
    ...
    answer: '不是。虽然1996年的一项经典研究（Adams et al.）发现，恐同程度高的异性恋男性在观看同性性刺激时表现出更强的生理唤起，但这并不意味着所有恐同者都在压抑自身的同性恋倾向。恐同的成因是多元的：社会文化conditioning、家庭教育、群体认同需求等都是重要因素。将恐同简单归结为"深柜"，反而忽略了偏见问题的复杂性。',
  },
  {
    id: 4,
    category: '关于治疗',
  ...
  },
  {
    ...
    answer: '机构、人物、案例、数据是虚构的，但其中引用的心理学概念和学术发现是真实的。例如，乔治·温伯格确实是"恐同症"概念的提出者；Adams等人1996年的研究确实发现了恐同与自身性取向焦虑的相关性；WHO确实在1990年将同性恋从疾病分类中删除。我们希望读者在感受讽刺的同时，也能获取真实的知识。',
  },
  {
    id: 10,
    category: '关于本网站',
    question: '如果我身边有人是恐同者，我应该怎么做？',
    answer: '首先，不要用攻击性的方式回应——愤怒往往会强化偏见。可以尝试：1）平静地分享科学事实；2）让他们接触性少数群体的真实故事；3）引导他们思考恐同态度的来源；4）如果他们愿意，建议他们阅读关于偏见心理学的书籍。最重要的是保持耐心——偏见的改变需要时间。但如果他们的行为已经构成骚扰或歧视，请勇敢地站出来维护正义。',
  },
];
