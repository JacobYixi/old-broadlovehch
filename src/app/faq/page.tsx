...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '不是。虽然1996年Adams等人的一项经典研究发现，恐同程度高的异性恋男性在观看同性性刺激时表现出更强的生理唤起，但这并不意味着所有恐同者都在压抑自身的同性恋倾向。恐同的成因是多元的：社会文化conditioning、家庭教育、群体认同需求等都是重要因素。将恐同简单归结为"深柜"，反而忽略了偏见问题的复杂性。',
  },
  {
    id: 4,
    category: '关于治疗',
