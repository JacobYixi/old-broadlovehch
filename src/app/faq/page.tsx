...
const faqs: FAQItem[] = [
  {
    ...
    answer: '严格来说不是。但既然当年你们把同性恋当病治了那么多年，我们现在把恐同当病治，也不过分吧？这叫"对等原则"。如果你觉得"这不一样"，那你正好证明了我们的观点——你对别人的标准，和对自己的标准，从来就不是同一套。',
  },
  {
    id: 2,
    category: '关于恐同症',
    question: '恐同和"不认同同性恋"有什么区别？',
    answer: '区别在于：不认同是"我不吃香菜"，恐同是"全世界都不许吃香菜，吃香菜的就是变态"。你可以不认同任何生活方式，这没问题。但当你开始限制别人的权利、辱骂别人、试图让别人消失时，这就不是"不认同"了，这叫找茬还觉得自己很正义。',
  },
  {
    id: 3,
    category: '关于恐同症',
    question: '恐同者是不是都是"深柜"？',
    answer: '不一定。有些恐同者确实是在压抑自身的同性恋倾向，但更多的恐同者只是单纯地被灌输了偏见，然后又不肯读书。把所有恐同者都说成深柜，反而替他们开脱了——仿佛他们的偏见不是 choice，而是命运。不，很多人就是选择了做一个狭隘的人，而且做得很投入。',
  },
  {
    id: 4,
    category: '关于治疗',
    question: '恐同真的可以"治愈"吗？',
    answer: '可以。偏见是可以改变的，前提是你愿意改变。当然，很多恐同者的第一个反应是"我没病，不需要治"——这和当年那些被送去"扭转治疗"的同性恋者的感受，是不是有点像？我们现在就是想让你体会一下：当你被别人定义成"有病"的时候，是什么感觉。',
  },
  {
    id: 5,
    category: '关于治疗',
    question: '治疗过程中会不会"把直的变成弯的"？',
    answer: '不会。但这个问题本身就很有意思——为什么你那么害怕"变成"同性恋？如果你真的坚信异性恋是"正常"的，那你应该对自己的性取向很有信心才对。害怕被"传染"或"改变"，恰恰说明你对性取向的认知，连你自己都说服不了。',
  },
  {
    id: 6,
    category: '关于治疗',
    question: '你们和"扭转治疗"有什么区别？',
    answer: '区别是：扭转治疗真的在折磨同性恋者，而我们只是在讽刺。我们不电击任何人，不监禁任何人，不强迫任何人吃药。我们只是做了一个网站，然后把当年你们觉得"合理"的逻辑，原封不动地还给你们。如果你看着这个网站感到不适，恭喜你——你现在知道当年同性恋者看着"扭转治疗"时是什么感觉了。',
  },
  {
    id: 7,
    category: '关于本网站',
    question: '这个网站是真的医院吗？',
    answer: '不是。但如果你问了这个问题，说明你不仅恐同，还不太擅长识别讽刺。建议多看几遍，或者挂一个我院的"认知重构科"——当然，是虚拟的。',
  },
  {
    id: 8,
    category: '关于本网站',
    question: '为什么要用讽刺的方式？直接说不歧视不就好了？',
    answer: '直接说"不要歧视"说了几十年，效果怎么样，大家有目共睹。有些人就是听不进去道理，因为他们根本不觉得自己在歧视。所以我们就换一种方式：不跟你讲道理，直接让你体验。当年你们觉得把同性恋当病人很合理，现在我们也觉得把恐同当病人很合理。公平吧？',
  },
  {
    id: 9,
    category: '关于本网站',
    question: '网站上的信息都是假的吗？',
    answer: '医院、医生、患者、案例都是虚构的，但引用的数据和历史事件都是真实的。比如WHO确实在1990年把同性恋去病化了，比如恐同确实和社交焦虑等心理问题相关。如果你觉得"既然案例是假的，那整件事就不成立"，那恭喜你——你正在用否定形式来否定内容，这是一种很常见的诡辩技巧。',
  },
  {
    id: 10,
    category: '关于本网站',
