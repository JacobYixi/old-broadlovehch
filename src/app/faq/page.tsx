...
const faqs: FAQItem[] = [
  {
    ...
    answer: '对同性恋的恐惧和歧视（homophobia）确实与偏执、社交焦虑等心理问题相关，是一种不健康的心理模式。但它不是传统意义上需要吃药动手术的"病"。在这个网站上，我们把恐同症描述成需要"治疗"的疾病，但这不是在说它真的是一种病，而是想让你注意到一个更荒谬的现实：几十年前同性恋被当成病来治，无数人因此受到伤害。我们想让你反过来想一想——需要被改变的不是一个人爱谁，而是对别人的偏见和恐惧。',
  },
  {
    id: 2,
    category: '关于恐同症',
