...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '让他们继续。一个恐同者最大的惩罚不是被骂，而是被当成病人。你可以：1）平静地分享本网站链接；2）告诉他们你认识一个专治恐同症的地方；3）在他们转发"同性恋是病"的时候，转发本网站说"你说得对，确实有这种病，就是这"；4）如果他们真的害怕自己是恐同症，建议他们来挂号。记住——恐同者不需要被说服，他们需要被治疗。',
  },
];
