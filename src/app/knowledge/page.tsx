...
const sections = [
  {
    ...
    content: [
      {
        title: '定义',
        text: '恐同症（Homophobia）是指对同性恋者或同性性行为产生非理性恐惧、厌恶、偏见或歧视的心理状态。它通常表现为：明明和自己无关的事，非要发表意见；明明什么都不懂，却坚信自己比科学家更正确；以及最经典的"我不是歧视，我只是……"。',
      },
      {
        title: '历史背景',
        text: '1972年，心理学家乔治·温伯格首次提出"恐同症"这一概念。1990年WHO把同性恋从疾病分类里删了，但恐同症至今没有列入疾病分类——不是因为不该列，而是因为医学界可能觉得"愚蠢"不在ICD的收录范围内。',
      },
      {
        title: '关键区分',
  ...
  },
  {
    ...
    content: [
      {
        title: '认知症状',
        text: '• 坚信同性恋是"不正常的"，尽管自己连WHO的决议都没读过\n• 将性少数群体的存在视为"对社会秩序的威胁"，但自己的存在似乎也没让社会变得更好\n• 选择性地相信反同谣言，对科学事实选择性失明\n• 认为自己的异性恋身份"优于"其他性取向，却拿不出任何证据，除了"我一直都是这样"',
      },
      {
        title: '情绪症状',
  ...
  },
  {
    ...
    content: [
      {
        title: '社会文化因素',
        text: '恐同症最常见的成因是：在一个长期把偏见当传统的社会里长大，很多人误以为"大家都这样"就等于"这样是对的"。同理，如果大家都用左手擦屁股，你也会觉得用右手的人不正常——这就是文化规训的力量。',
      },
      {
        title: '家庭教育影响',
        text: '很多家长自己也没读过几本书，却热衷于把偏见当家训传给下一代。当父母在家中使用贬低性语言表达对同性恋的厌恶时，子女通常有两种选择：继承偏见，或者被当成"不孝子"。这就是为什么恐同常常是一种"家族遗传病"。',
      },
      {
        title: '自身性取向焦虑',
        text: '1996年Adams等人的研究发现，恐同程度高的男性在观看同性性刺激时表现出更强的生理唤起。当然，不是所有恐同者都是深柜，但有一部分人确实在用恐同来掩盖自己内心的波动。就像那个著名比喻：叫得越凶的狗，越可能是怕的。',
      },
      {
        title: '群体认同需求',
