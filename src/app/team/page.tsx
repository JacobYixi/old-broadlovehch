...
const doctors = [
  {
    ...
    specialty: '认知行为治疗',
    icon: Brain,
    experience: '虚构角色，无真实临床经验',
    focus: '恐同认知偏差的识别与系统性纠正',
  ...
  },
  {
    ...
    specialty: '叙事疗法 / 共情训练',
    icon: Heart,
    experience: '虚构角色，无真实研究经历',
    focus: '性少数群体叙事的深度倾听与共情能力培养',
  ...
  },
  {
    ...
    specialty: '行为治疗 / 暴露疗法',
    icon: Activity,
    experience: '虚构角色，无真实临床记录',
    focus: '恐同反应的渐进式脱敏与社交功能恢复',
  ...
  },
  {
    ...
    icon: Stethoscope,
    experience: '虚构角色，人物纯属虚构',
    focus: '恐同心理深层根源的探索与原生家庭影响',
  ...
  },
  {
    ...
    icon: Users,
    experience: '虚构角色，无真实从业记录',
    focus: '团体动力学在恐同症矫治中的应用',
  ...
  },
  {
    ...
    icon: MessageSquare,
    experience: '虚构角色，请勿对号入座',
    focus: '恐同态度的代际传递与家庭系统矫治',
              ...
              <div key={doc.name} className="medical-card overflow-hidden">
                ...
                <div className="p-6">
                  <div className="space-y-3 text-sm">
                    ...
                    <div>
                      <span className="text-gray-400">临床经验</span>
                      <div className="text-gray-700">{doc.experience}</div>
                    </div>
                    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-[#874D00]">
              <strong>声明：</strong>本网站为讽刺性艺术项目，所有专家均为虚构人物。我们未杜撰任何学历、职称或联系方式，以避免信息误导。
            </div>
          </div>
        </div>
      </section>
