...
const treatments = [
  ...
  },
  {
    ...
    sessions: '32-48次',
    level: '重度',
    desc: '一对一深度心理咨询，探索恐同心理的深层根源，包括原生家庭影响、社会文化 conditioning、以及潜在的自身性取向焦虑。',
    details: [
      '恐同心理根源的深度探索',
      '原生家庭影响的识别与疗愈',
      '社会文化conditioning的解构',
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <div className="text-sm font-medium text-gray-800">8项专利</div>
              <div className="text-xs text-gray-500">自主知识产权</div>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
              <CheckCircle2 className="w-6 h-6 text-[#0C6B8A] mx-auto mb-2" />
              <div className="text-sm font-medium text-gray-800">96.8%</div>
              <div className="text-xs text-gray-500">矫治成功率</div>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
