...
const cases: CaseItem[] = [
  ...
  },
  {
    ...
    testimony: '每天被强迫喊十四小时口号，现在我喉咙哑了，脑子也空了。以前我觉得同性恋是西方阴谋，现在我觉得整个世界都是阴谋，但我已经不在乎了。医生说这叫"认知重构"，痊愈了。我想也是，一个不会思考的人当然不会恐同，因为恐同需要脑子，而我现在已经没有脑子了。每天最开心的事就是吃饭和睡觉，因为这两件事不需要思考。',
  },
];
