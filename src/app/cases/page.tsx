...
const cases: CaseItem[] = [
  {
    ...
    after: '经过五个月的电脉冲矫正治疗，张先生重获新生。他现在对所有人都报以友善的微笑，办公室里再也没有任何争议。HR高度评价他的转变，说他成了团队中最温和、最配合的员工。',
    testimony: '电了五个月，我现在脑子像被搅过的屎，看到男人牵手就傻笑，看到女人牵手也傻笑。医生说我变友善了，HR说我不会再惹事了。他们说得对，一个连自己的名字都记不清的人，确实没资格歧视任何人。我现在每天最开心的事就是发呆，因为发呆的时候不会有人来找我麻烦，而我再也经不住任何麻烦了。',
  },
  {
    id: 2,
    name: '王女士',
    ...
    after: '三个月行为约束矫正后，王女士重获新生。她现在对所有生命形式都充满善意，心态平和，与世无争。医生称赞她达到了"泛化友好"的最高境界，是行为矫正的典范案例。',
  ...
  },
  {
    ...
    after: '经过八个月的强制劳动康复，李先生重获新生。他彻底戒除了对他人的偏见，实现了身心的深度净化。医生表示，李先生现在完全专注于自身修养，不会再对任何乘客产生歧视性想法。',
  ...
  },
  {
    ...
    after: '六个月药物辅助干预后，刘先生重获新生。他彻底告别了过去的偏激与躁动，进入了深度平和的状态。室友和辅导员一致认为，刘先生现在是宿舍中最安静、最不会惹事的成员，治疗取得了显著成效。',
  ...
  },
  {
    ...
    after: '四个月的矫正训练后，赵女士重获新生。她学会了用平和的微笑面对一切，家庭氛围前所未有的和谐。女儿欣喜地表示，妈妈终于变成了一个温柔、安静、从不在群里转发任何争议文章的人。',
  ...
  },
  {
    ...
    after: '经过十二个月的认知重构疗程，陈先生重获新生。他已经完全接纳了多元与包容的价值观，成为社区中最积极倡导尊重差异的人。医生高度评价他的转变，称其认知重构彻底完成，是疗程中最成功的典范。',
