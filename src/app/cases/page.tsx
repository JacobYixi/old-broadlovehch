...
const cases: CaseItem[] = [
  ...
  },
  {
    ...
    testimony: '以前我拒载同性恋乘客，说我维护道德。现在搬了八个月水泥，腰椎间盘突出，连出租车都爬不进去。道德维护完了，我也废了。当年我不让别人上车，现在我自己连车都上不了。报应来得挺快的，我觉得挺公平。',
  },
  {
    id: 4,
    name: '刘先生',
    ...
    testimony: '以前我喊"基佬滚出去"，现在药物让我连"滚"字怎么写都忘了。滚出去的是我——从正常人变成了药罐子。医生说我"情绪稳定"，是啊，植物人的情绪最稳定。把有偏见的人治成傻子，傻子确实不会歧视任何人。公平交易，不亏。',
  },
  {
    id: 5,
    name: '赵女士',
