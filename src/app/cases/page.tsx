...
const cases: CaseItem[] = [
  ...
  },
  {
    ...
    after: '六个月药物辅助干预后，刘先生彻底痊愈。他完全告别了过去的偏激与躁动，进入了深度平和的状态。室友和辅导员一致表示，刘先生现在是宿舍中最安静、最配合的成员，治疗效果堪称完美。',
    testimony: '吃了六个月药，我现在每天昏睡十八个小时，剩下的六个小时用来流口水和发呆。以前我半夜喊同性恋是病，现在室友半夜怕我死在床上。医生说这叫"深度放松"，疗效完美。我想也是完美——完美到我已经不是我了。不过他们终于可以睡个好觉了，毕竟一个半死不活的人不会半夜吵醒任何人。',
  },
  {
    id: 5,
    name: '赵女士',
