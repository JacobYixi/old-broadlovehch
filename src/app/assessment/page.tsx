...
function getResult(score: number) {
  ...
  if (percentage <= 10) {
    return {
      ...
      advice: '感谢你的理解与支持。如果你愿意，可以把这个测试分享给你身边对性少数议题还不够了解的朋友，帮助他们认识自己。',
    };
    ...
    return {
      ...
      icon: CheckCircle2,
      desc: '你可能存在一些轻微的恐同倾向，这在当前社会环境中较为常见。好消息是，轻度的认知偏差通过教育和自我反思是可以改善的。',
      advice: '建议通过阅读权威性少数群体相关科普资料、观看纪录片等方式增进了解。本院提供免费的心理评估服务，欢迎预约咨询。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '你存在较明显的恐同倾向，这可能已经开始影响你的人际关系和社会功能。研究表明，中度恐同倾向若不及时干预，有进一步恶化的风险。',
      advice: '建议尽快预约我院门诊，接受专业的认知评估。本院采用循证医学方法，根据患者具体情况制定个性化矫治方案。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '你存在严重的恐同倾向，可能已经对他人造成伤害，同时也严重影响了自身的心理健康。研究显示，重度恐同者常伴有焦虑、偏执等共病症状。',
      advice: '强烈建议尽快接受系统治疗。本院提供电击矫正疗法、行为约束矫正等多种治疗方案，均基于多年临床研究，疗效显著。',
    };
  } else {
    return {
      level: '极度恐同症',
      ...
      icon: XCircle,
      desc: '测试结果表明，你处于极度恐同状态，伴有强烈的敌意和攻击性。这种状态不仅对社会构成潜在威胁，也说明你可能正遭受深层的心理困扰。',
      advice: '请立即预约我院接受全面评估。本院拥有国内领先的恐同症综合矫治体系，包括药物干预、电刺激矫正、认知灌输等多种疗法，可根据病情制定联合治疗方案。',
    };
  }
}
