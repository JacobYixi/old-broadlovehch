...
function getResult(score: number) {
  ...
  if (percentage <= 10) {
    ...
    return {
      ...
      icon: CheckCircle2,
      desc: '你可能有一些轻微的恐同倾向，也许你自己都没意识到。比如看到同性牵手会"本能"地移开视线——这种"本能"其实不是本能，是后天被灌输的。',
      advice: '趁还来得及，多读点书，少刷点评论区。你现在的状态属于"还能抢救"，别等病情加重了才后悔。',
    };
    ...
    return {
      ...
      advice: '建议预约我院门诊。不用担心，我们使用的都是你们当年觉得"合理"的疗法，绝对"科学"、"有效"。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '你的恐同已经到了需要"住院观察"的程度。你可能经常在网上和人吵架，认为同性恋在"毁掉社会"，甚至尝试过阻止身边的性少数朋友"太张扬"。',
      advice: '强烈建议尽快预约我院电击矫正科或行为约束科。放心，这些疗法曾经被人认为是"为了你好"。现在，我们也一样。',
    };
  } else {
    return {
      level: '极度恐同症',
      ...
      icon: XCircle,
      desc: '测试结果表明，你是一个教科书级别的恐同症患者。你对性少数群体的敌意已经达到了"需要立即干预"的水平——当然，是你当年定义的那种"干预"。',
      advice: '别跑了，你就是我们医院的VIP客户。电击、监禁、药物、洗脑，套餐齐全，任选其一。毕竟当年你也觉得这些手段"很有必要"。',
    };
  }
}
