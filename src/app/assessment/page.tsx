...
function getResult(score: number) {
  ...
  if (percentage <= 10) {
    return {
      ...
      icon: CheckCircle2,
      desc: '你展现出了良好的包容性和平等意识。你对性取向多样性有健康的认知，能够自然地尊重每一个人。',
      advice: '继续做你自己！你可以成为身边人的榜样，帮助更多人建立平等包容的认知。',
    };
    ...
    return {
      ...
      icon: CheckCircle2,
      desc: '你可能存在一些轻微的恐同倾向，这在社会环境中非常常见，不必过于自责。关键在于你愿意正视它。',
      advice: '建议多接触性少数群体的真实生活故事，培养共情能力。你的轻微不适可以通过自我教育来消除。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '你存在较明显的恐同倾向，这可能表现为对同性恋者的不适、回避或隐性歧视。这种倾向可能会影响你的人际关系和社会功能。',
      advice: '建议寻求专业心理咨询帮助，了解恐同心理的深层成因，学习更平等包容的认知方式。认知重构疗法可能对你有帮助。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '你存在严重的恐同倾向，可能已经对他人造成了伤害，同时也严重影响了你自身的心理健康和社交功能。',
      advice: '强烈建议尽快寻求专业治疗。深度心理疏导结合认知重构疗法和共情唤醒疗程，可以有效帮助你摆脱恐同的困扰。',
    };
  } else {
    return {
      level: '极度恐同症',
      ...
      icon: XCircle,
      desc: '你表现出极度严重的恐同症状，可能伴有强烈的敌意和攻击性。这种状态不仅伤害他人，也说明你可能正遭受深层的心理困扰。',
      advice: '请立即寻求专业心理帮助。你的恐同可能源于对自身的不确定感或其他深层心理问题。记住：寻求帮助不是软弱，而是勇气的表现。',
    };
  }
}
