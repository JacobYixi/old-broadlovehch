...
const services = [
  ...
  },
  {
    icon: Heart,
    title: '共情唤醒疗程',
    desc: '先把你关起来，再问你懂不懂共情。别担心，这不是虐待，这叫"沉浸式体验"。',
    href: '/services',
  },
  {
    icon: Activity,
    title: '行为脱敏训练',
    desc: '每天强制观看同性恋相关内容直到麻木。当年你们觉得"脱敏"是科学，现在科学轮到你头上了。',
    href: '/services',
  },
  {
    icon: Stethoscope,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  世界卫生组织早就把同性恋从疾病分类里删了，但有些人显然还没收到通知——
                  或者收到了，但觉得自己比WHO更懂医学。没关系，我们专治这种病，
                  学名叫做"明明不懂却很喜欢发表意见的盲目自信"。
                </p>
                <p>
      ...
      <section className="medical-gradient text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/80 mb-8 text-lg">
            别慌，很多人并不知道自己有病。就像当年很多人并不知道"治疗"同性恋有多荒谬。
            <br />
